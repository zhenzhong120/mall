      ...
      <div class="container">
        <div class="checkout-addr">
            ...
            <div class="addr-list">
              <ul>
                <li
                  ...
                  @click="checkIndex = index;selectedId = item.addressId"
                >
                  <dl>
                    <dt>{{item.userName}}</dt>
                  ...
                  <div class="addr-opration addr-del">
                    <a
                      href="javascript:;"
                      class="addr-del-btn"
                      @click="delAddressConfrim(item.addressId)"
                    >
          ...
          <div class="next-btn-wrap">
            <router-link class="btn btn--m btn--red" :to="{path:'orderConfrim',query:{'addressId':selectedId}}">Next</router-link>
          </div>
        </div>
      </div>
    </div>
