<template>
  <div>
              ...
              <li v-for="item in cartList">
                <div class="cart-tab-1">
                  ...
                  <div class="cart-item-pic">
                    <img v-bind:src="'/static/img/'+item.productImg" v-bind:alt="item.productName" />
                  </div>
                ...
                <div class="cart-tab-4">
                  ...
                  >{{(item.productNum*item.productPrice) | currency("￥")}}</div>
                </div>
    ...
    <Modal :mdShow="modalConfirm" @close="colseModal">
  ...
  methods: {
    ...
    editCart(flag, item) {
      if (flag == "add") {
        ...
        item.checked = item.checked == "1" ? "0" : "1"; //复选框取反
      }
      this.axios
        .post("/users/cartEdit", {
    ...
    toggleCheckAll() {
      ...
      //checkAllFlag是实时属性的计算，如果判断checkout和cartList的长度相等，不能再次被赋值，利用第三方数据实现
